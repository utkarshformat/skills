...
1. Opening & permission / reason-for-call (do they get a real conversation at all?)
2. Discovery / pain (are they learning anything?)
3. Value framing (are they connecting it?)
4. Objection handling (do brush-offs end the call?)
5. Next step (do they leave with something dated?)

A rep failing at discovery should not be coached on objection reframing yet — it's wasted effort. Name **one** priority per rep, the earliest unmet rung on this ladder.

## Disqualifications are not coaching material
